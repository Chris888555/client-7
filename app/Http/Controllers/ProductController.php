...
class ProductController extends Controller
{
    ...
    public function uploadProduct(Request $request)
    {
        ...
        $request->validate([
            ...
            'product_purchased' => 'nullable|numeric|min:1',
        ...
        $product->product_purchased = $request->product_purchased;
 ...
 public function showShop($subdomain)
{
    ...
    // Pass user and subdomain to the view
    return view('shop', compact('products', 'brands', 'user', 'subdomain'));
}
