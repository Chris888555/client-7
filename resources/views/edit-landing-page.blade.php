...
<div class="container m-auto p-4 sm:p-8 max-w-full">
    ...
    <h1 class="text-2xl md:text-3xl font-bold text-left text-blue-400">Edit Landing Page</h1>
    <p class="text-gray-600 text-left mb-4">Easily manage and customize the content of your landing page to suit your
        needs and preferences. </p>

    <form method="POST" action="{{ route('update.landing') }}" enctype="multipart/form-data">
        @csrf

        <div class="mb-4 border-2 border-gray-300 p-6 rounded-lg ">
            <div class="mb-4">
                <label for="page_link_2" class="block text-sm font-medium text-gray-700">Page Link</label>
                <input type="text" id="page_link_2" name="page_link_2"
                    class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value="{{ old('page_link_2', $funnel->page_link_2 ?? '') }}" oninput="validatePageLink(this)">
                <!-- Error message container -->
                <p id="page_link_2_error" class="text-sm mt-1 text-red-500 hidden">Only letters, numbers, and dashes (-)
                    are
                    allowed.</p>
            </div>
            ...
            function validatePageLink(input) {
                ...
                const errorMessage = document.getElementById('page_link_2_error');
            ...
            <div class="flex flex-col md:flex-row gap-4 mb-4">
                <div class="flex-1">
                    ...
                    <input type="text" id="headline" name="headline"
                        class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        value="{{ old('headline', $landingPageContent['headline'] ?? '') }}">
                </div>
                <div class="flex-1">
                    ...
                    <input type="text" id="subheadline" name="subheadline"
                        class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        value="{{ old('subheadline', $landingPageContent['subheadline'] ?? '') }}">
                </div>
            </div>
        </div>
        ...
        <div class="mb-4 border-2 border-gray-300 p-6 rounded-lg ">
            <!-- Video Link -->
            <div class="mb-4">
                <label for="video_link" class="block text-sm font-medium text-gray-700">Video Link / Youtube or
                    MP4</label>
                <input type="text" id="video_link" name="video_link"
                    class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value="{{ old('video_link', $landingPageContent['video_link'] ?? '') }}">
            </div>
        ...
        <div class="mb-4 border-2 border-gray-300 p-6 rounded-lg ">
            <div class="flex-1 mb-4 ">
                ...
                <input type="text" id="intro_headline" name="intro_headline"
                    class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value="{{ old('intro_headline', is_array($landingPageContent['intro_headline'] ?? '') ? implode(', ', $landingPageContent['intro_headline']) : $landingPageContent['intro_headline'] ?? '') }}">
            </div>
            ...
            <div class="flex-1 mb-4">
                ...
                <input type="text" id="intro_paragraph" name="intro_paragraph"
                    class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value="{{ old('intro_paragraph', is_array($landingPageContent['intro_paragraph'] ?? '') ? implode(', ', $landingPageContent['intro_paragraph']) : $landingPageContent['intro_paragraph'] ?? '') }}">
            </div>
            ...
            <div class="flex-1 mb-4">
                ...
                <input type="text" id="benefits_title" name="benefits_title"
                    class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value="{{ old('benefits_title', is_array($landingPageContent['benefits_title'] ?? '') ? implode(', ', $landingPageContent['benefits_title']) : $landingPageContent['benefits_title'] ?? '') }}">
            </div>

            @php
    $benefitsListRaw = $landingPageContent['benefits_list'] ?? '';
     ...
     <div class="mb-4">
        ...
        const oldBenefits = {!! json_encode(
            old('benefits_list')
                ...
                : (isset($landingPageContent['benefits_list']) 
                    ? (is_array($landingPageContent['benefits_list']) 
                        ? $landingPageContent['benefits_list'] 
                        : explode(',', $landingPageContent['benefits_list'])) 
                    : [])
        ) !!};
        ...
        <div class="mb-4 border-2 border-gray-300 p-6 rounded-lg ">
            <div class="flex flex-col md:flex-row gap-4 mb-4">
                <div class="flex-1">
                    ...
                    <input type="text" id="testimonial_headline" name="testimonial_headline"
                        class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        value="{{ old('testimonial_headline', $landingPageContent['testimonial_headline'] ?? '') }}">
                </div>
                <div class="flex-1">
                    ...
                    <input type="text" id="testimonial_subheadline" name="testimonial_subheadline"
                        class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        value="{{ old('testimonial_subheadline', $landingPageContent['testimonial_subheadline'] ?? '') }}">
                </div>
            </div>
            ...
            <!-- Testimonial Images -->
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700">Testimonial Images / Select Multiple
                    Images</label>
            ...
            <div class="mb-4">
                ...
                <div class="flex flex-col sm:flex-row gap-2">
                    <input type="number" name="fomo_days"
                        ...
                        value="{{ old('fomo_days', $landingPageContent['fomo_countdown']['days'] ?? '') }}"
                        placeholder="Days">
                    <input type="number" name="fomo_hours"
                        class="w-full sm:w-1/3 border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        value="{{ old('fomo_hours', $landingPageContent['fomo_countdown']['hours'] ?? '') }}"
                        placeholder="Hours">
                    <input type="number" name="fomo_minutes"
                        class="w-full sm:w-1/3 border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        value="{{ old('fomo_minutes', $landingPageContent['fomo_countdown']['minutes'] ?? '') }}"
                        placeholder="Minutes">
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <div class="w-full">
                    ...
                    <input type="text" id="Referral_link" name="Referral_link"
                        class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        value="{{ old('Referral_link', $landingPageContent['Referral_link'] ?? '') }}">
                    <div class="mt-2">
                        <label class="inline-flex items-center text-sm">
                            <input type="checkbox" name="Referral_link_toggle" class="mr-2"
                                {{ old('Referral_link_toggle', $landingPageContent['Referral_link_toggle'] ?? false) ? 'checked' : '' }}>
                            Show Referral Link
                        </label>
                    </div>
                </div>
                ...
                <div class="w-full">
                    ...
                    <input type="text" id="Referral_button_text" name="Referral_button_text"
                        class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        value="{{ old('Referral_button_text', is_array($landingPageContent['Referral_button_text'] ?? '') ? implode(', ', $landingPageContent['Referral_button_text']) : $landingPageContent['Referral_button_text'] ?? '') }}">
                </div>

                <!-- Referral Button Subtext -->
                <div class="w-full">
                    ...
                    <input type="text" id="Referral_button_subtext" name="Referral_button_subtext"
                        class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        value="{{ old('Referral_button_subtext', is_array($landingPageContent['Referral_button_subtext'] ?? '') ? implode(', ', $landingPageContent['Referral_button_subtext']) : $landingPageContent['Referral_button_subtext'] ?? '') }}">
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <div class="w-full">
                    ...
                    <input type="text" id="Group_chat_link" name="Group_chat_link"
                        class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        value="{{ old('Group_chat_link', $landingPageContent['Group_chat_link'] ?? '') }}">
                    <div class="mt-2">
                        <label class="inline-flex items-center text-sm">
                            <input type="checkbox" name="Group_chat_link_toggle" class="mr-2"
                                {{ old('Group_chat_link_toggle', $landingPageContent['Group_chat_link_toggle'] ?? false) ? 'checked' : '' }}>
                            Show Group Chat Link
                        </label>
                    </div>
                </div>

                <!-- Group Chat Button Text -->
                <div class="w-full">
                    <label for="Group_chat_button_text" class="block text-sm font-medium text-gray-700">Group Chat
                        Button Text</label>
                    <input type="text" id="Group_chat_button_text" name="Group_chat_button_text"
                        class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        value="{{ old('Group_chat_button_text', is_array($landingPageContent['Group_chat_button_text'] ?? '') ? implode(', ', $landingPageContent['Group_chat_button_text']) : $landingPageContent['Group_chat_button_text'] ?? '') }}">
                </div>

                <!-- Group Chat Button Subtext -->
                <div class="w-full">
                    <label for="Group_chat_button_subtext" class="block text-sm font-medium text-gray-700">Group Chat
                        Button Subtext</label>
                    <input type="text" id="Group_chat_button_subtext" name="Group_chat_button_subtext"
                        class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        value="{{ old('Group_chat_button_subtext', is_array($landingPageContent['Group_chat_button_subtext'] ?? '') ? implode(', ', $landingPageContent['Group_chat_button_subtext']) : $landingPageContent['Group_chat_button_subtext'] ?? '') }}">
                </div>
            </div>
        </div>
        ...
        <div class="mb-4 border-2 border-gray-300 p-6 rounded-lg">
            ...
            <input type="text" id="Messenger_link" name="Messenger_link"
                class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                value="{{ old('Messenger_link', $landingPageContent['Messenger_link'] ?? '') }}">
            <input type="checkbox" name="Messenger_link_toggle" class="ml-2"
                {{ old('Messenger_link_toggle', $landingPageContent['Messenger_link_toggle'] ?? false) ? 'checked' : '' }}>
            Show Messenger Link
        </div>
