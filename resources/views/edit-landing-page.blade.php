...
<div class="container m-auto p-4 sm:p-8 max-w-full">
    ...
    <p class="text-gray-600 text-left mb-4">Easily manage and customize the content of your landing page to suit your needs and preferences. </p>
    ...
    <input type="text" id="page_link_2" name="page_link_2"
        ...
        value="{{ old('page_link_2', $funnel->page_link_2 ?? '') }}"
        oninput="validatePageLink(this)">
    <!-- Error message container -->
    <p id="page_link_2_error" class="text-sm mt-1 text-red-500 hidden">Only letters, numbers, and dashes (-) are allowed.</p>
</div>
        ...
        <div class="mb-4">
            ...
            <div class="flex flex-col sm:flex-row gap-2">
                <input type="number" name="fomo_days"
                    ...
                    value="{{ old('fomo_days', $landingPageContent['fomo_countdown']['days'] ?? '') }}" placeholder="Days">
                <input type="number" name="fomo_hours"
                    class="w-full sm:w-1/3 border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value="{{ old('fomo_hours', $landingPageContent['fomo_countdown']['hours'] ?? '') }}" placeholder="Hours">
                <input type="number" name="fomo_minutes"
                    class="w-full sm:w-1/3 border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value="{{ old('fomo_minutes', $landingPageContent['fomo_countdown']['minutes'] ?? '') }}" placeholder="Minutes">
            </div>
        </div>
