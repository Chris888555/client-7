...
<div class="container m-auto p-4 sm:p-8 max-w-full">
    ...
    <h1 class="text-2xl md:text-3xl font-bold text-left text-blue-400">Edit Funnel Page</h1>
    <p class="text-gray-600 text-left mb-4">Easily manage and customize the content of your funnel page to suit your needs and preferences. </p>
