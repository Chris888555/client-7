...
<div class="flex justify-center mb-16 w-full max-w-md mx-auto">
    ...
    <div class="flex-1 relative">
        <div id="step1Indicator" class="w-full h-3 rounded-l-full bg-indigo-600 transition-all"></div>
    ...
    <div id="step1" class="space-y-6 ">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 ">
            ...
            <div class="w-full overflow-hidden">
                ...
                <button type="button" class="mt-3 w-full bg-indigo-600 hover:bg-indigo-600 text-white py-2 rounded-lg"
    ...
    <div id="step2" class="hidden">
        <h3 class="text-xl font-semibold mb-4">Payment & Basic Info</h3>

        <!-- Package Summary -->
        <div id="packageSummary" class="mb-6 border rounded-xl p-4 bg-gray-50 shadow-sm">
            <h4 class="font-semibold text-lg" id="summaryName"></h4>
            <p class="text-indigo-600 font-bold text-base" id="summaryPrice"></p>
        </div>
        ...
        <form id="checkoutForm" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <select id="paymentSelect" name="payment_method_id" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-gray-200 mb-4" required>
                ...
                <div id="paymentCard" class="hidden border rounded-xl shadow-md p-6 bg-white mb-6">
                    ...
                    <p class="text-sm text-green-500">Send your payment to this account.</p>
                </div>
            </div>
            ...
            <div>
                ...
                <input type="text" name="full_name" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-gray-200" required>
            </div>

            <div>
                <label class="block font-medium mb-1">Mobile Number</label>
                <input type="text" name="mobile" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-gray-200" required>
            </div>
    ...
    fileInput.addEventListener('change', () => {
        if(fileInput.files.length > 0){
            ...
            <div class="flex justify-between">
                ...
                <button type="submit" class="bg-indigo-600 text-white px-4 py-2 rounded-lg">Submit Order</button>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    function goToStep2(packageId, name, price) {
        ...
        document.getElementById('step2Indicator').className = "px-4 py-2 rounded-full bg-indigo-600 text-white";
    ...
    function goBackStep1() {
        ...
        document.getElementById('step1Indicator').className = "px-4 py-2 rounded-full bg-indigo-600 text-white";
