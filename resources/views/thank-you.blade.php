...
<body class="bg-gray-50">
    ...
    ← Back to Shop
        ...
        <!-- Thank You Message -->
        <div class=" flex flex-col items-center sm:flex-row sm:items-center sm:justify-start text-green-600 text-3xl font-bold mb-6 mt-10 md:mt-0">
...
<div class="mt-6 bg-white p-6 rounded-lg shadow-[inset_0px_3px_34px_1px_#00000024] border-2 border-gray-300">
    ...
    <a href="{{ $user->facebook_link }}" target="_blank" id="contact-us-btn" class="inline-block w-full max-w-xs md:max-w-md z-50">
        <button
  ...
  <div class="flex justify-center mt-4 mb-16">
    <a href="{{ $user->join_fb_group }}" target="_blank" id="contact-us-btn" class="inline-block w-full max-w-xs md:max-w-md z-50">
        <button
            class="w-full flex items-center justify-center bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded-md shadow space-x-2">
