...
<section class="sidebar-section">
   ...
   <aside id="sidebar" 
    ...
    style="width: 280px; height: calc(100vh - 1rem); background-color: #2b6f6d;">
        ...
        <!-- ✅ MENU -->
        <nav class="flex flex-col overflow-y-auto overflow-x-hidden max-h-[calc(100vh-150px)]">
         ...
         <li>
            ...
            <a href="{{ route('payment-method.create') }}"
             ...
             <a href="{{ route('user.academy.courses') }}"
                    class="sidebar-item flex items-center gap-4 px-3 py-2 transition rounded-lg"
                    style="color: {{ $theme->nav_text_color }};"
                    onmouseover="this.style.backgroundColor='{{ $theme->nav_hover_bg_color }}'; this.style.color='{{ $theme->nav_text_hover_color }}';"
                    onmouseout="this.style.backgroundColor=''; this.style.color='{{ $theme->nav_text_color }}';">
        ...
        <!-- Bottom actions -->
        <div class="mt-auto flex flex-col gap-2 pt-4 border-t border-gray-500">
            
            <a href="/myprofile"
            class="sidebar-item flex items-center gap-4 px-3 py-2 rounded-lg"
            style="color: {{ $theme->nav_text_color }};">
                ...
                <span class="sidebar-text text-base">Edit Profile</span>
            </a>

            <form action="/logout" method="POST">
                @csrf
                <button type="submit" class="sidebar-item flex items-center gap-4 px-3 py-2 rounded-lg w-full text-left"
                        style="color: {{ $theme->nav_text_color }}; background-color: transparent;">
                    <div class="rounded-lg p-2 flex items-center justify-center"
                        style="background-color: {{ $theme->icon_bg_color }}; color: {{ $theme->icon_text }};">
