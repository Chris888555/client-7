...
<header class="bg-white shadow-md py-4 fixed w-full top-0 z-50">
    <div class="container mx-auto flex justify-between items-center px-6">
        ...
        <nav class="hidden md:flex space-x-6">
            ...
            <a href="{{ route('register') }}" class="text-gray-700 hover:text-blue-500 font-semibold transition">Sign
                Up</a>
        </nav>
        ...
        <!-- Right: Logo/Text -->
        <div>
            <a href="{{ route('home') }}" class="text-xl font-bold text-gray-500">Sybbex Team Ph</a>
        </div>
    </div>
