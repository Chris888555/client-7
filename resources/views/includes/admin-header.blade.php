        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center">
                    <a href="{{ route('dashboard') }}" class="text-lg font-bold text-gray-800">My Logo</a>
                </div>

                <!-- Center: Navigation Links -->
                <nav class="hidden md:flex space-x-6">
                    <a href="{{ route('admin.manage-users') }}" class="text-gray-600 hover:text-blue-500">
                        Users</a>

                    <a href="{{ route('admin.upload-playlist') }}" class="text-gray-600 hover:text-blue-500">
                        Upload Playlists</a>

                    <a href="{{ route('marketing.index') }}" class="text-gray-600 hover:text-blue-500">
                        Upload Marketing</a>
            ...
            <nav id="mobile-menu" class="md:hidden hidden bg-white pt-4 pb-4">
                <a href="{{ route('admin.manage-users') }}"
                    class="block px-4 py-2 text-gray-600 hover:bg-gray-100">Users</a>

                <a href="{{ route('admin.upload-playlist') }}"
                    class="block px-4 py-2 text-gray-600 hover:bg-gray-100">Upload Playlists</a>

                <a href="{{ route('marketing.index') }}" class="block px-4 py-2 text-gray-600 hover:bg-gray-100">Upload
                    Marketing</a>
