...
<body class="bg-gray-100 flex items-center justify-center px-2  ">
    <div class="container m-auto p-4 sm:p-8 max-w-full">
        <h2 class="text-2xl font-bold text-left ">Manage Your Account</h2>
            <h3 class="text-sm  text-left mb-8">Update your profile photo and personal details</h3>
 ...
 <!-- Update Name and Email Section -->
        <div class="mt-6  rounded-2xl  w-full sm:max-w-[500px]  ">
