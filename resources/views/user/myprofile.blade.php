...
<div class="container m-auto p-4 sm:p-8 max-w-full">
    ...
    <x-page-header-text title="Manage Your Account" subtitle="Update your profile photo and personal details." />
    <div class="flex items-center justify-center bg-gray-50">
        <div class="w-full  bg-white p-6 sm:p-10 rounded-2xl border border-gray-200 flex flex-col md:flex-row gap-10">
            ...
            <div class="flex flex-col flex-1 gap-8">
                ...
                <!-- Tabs -->
                <div class="flex justify-center md:justify-start gap-4 border p-2 max-w-[370px] rounded-2xl">
