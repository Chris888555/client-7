    ...
    <div class="bg-white p-6 mt-6 rounded-lg shadow hover:shadow-lg transition">
        ...
        <div class="flex items-center mt-4 space-x-2">
            ...
            <a href="{{ route('funnel.main') }}"
                class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 text-center shadow-sm transition duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 flex items-center">
