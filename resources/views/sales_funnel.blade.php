...
<body class="pt-0">
    <div class=" w-full sm:max-w-[900px] p-6 text-center mx-auto mt-2 sm:mt-10">
        ...
        <h1
            ...
            Struggling to Make Sales? This Funnel Does the Selling For You</h1>

        <p class="text-2xl sm:text-3xl text-gray-200 mt-2 capitalize">Automate your leads, boost your sales, and grow
    ...
    <div class="max-w-3xl w-full text-center mx-auto p-2">
        ...
        <div class="relative w-full">
            ...
            <video id="custom-video" controls
                ...
                <source src="https://d1yei2z3i6k35z.cloudfront.net/1841686/67e52a5463b4f_v3_SYBBEXVIDEOAD.mp4"
                    type="video/mp4">
        ...
        <p class="text-sm text-gray-300 rounded-lg mt-6">
            Ready to start and earn passive income? Message mo ako sa Messenger para ma-guide kita paano mag-create
            account at mag-deposit.
        </p>
