    ...
    <div class="max-w-3xl w-full text-center mx-auto p-2">
        <div class="mt-6">
             <div
                ...
                <p class="text-base sm:text-2xl font-bold text-yellow-300 flex items-center gap-2">
                    <span class="material-icons text-base sm:text-2xl">visibility</span>
                    Total Views: {{ number_format($viewer_count) }}
                </p>
                </div>
